      ...
      <Container style={{maxWidth: '100%', minWidth: '100%', maxHeight: '100%', minHeight: '100%'}}>
        <MediaQuery query="(min-device-width: 850px)">
          <Menu  inverted fluid secondary size='massive' stackable text style={{alignItem: 'center'}} >
            ...
            <Menu.Item as={ Link } name='home' to='accommodation' active active> <Icon name='hotel'  /> Accommodation </Menu.Item>
            ...
            <Menu.Item as={ Link } name='dresscode' to='dress-code' active> <Icon name='empty star' /> What to Wear </Menu.Item>
          </Menu>
        </MediaQuery>
